...
#define BOUNDED_HLL_VALIDATION_CONTRACT "bhllvalyyyyy"
#define BOUNDED_HLL_CONTRACT "boundedhllyy"
#define ORCHESTRATOR_CONTRACT "orchyyyyyyyy"
#define ORG_CONTRACT "organizayyyy"

CONTRACT bhllmanager : public contract {
public:
  ...
  ACTION activate(name authorized, symbol agg_symbol, symbol badge_symbol);

  ACTION deactivate(name authorized, symbol agg_symbol, symbol badge_symbol);
