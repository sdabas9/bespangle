...
ANTIBADGE_MANAGER_CONTRACT="abmanagerzzz"
REPUTATION_MANAGER_CONTRACT="repmanagerxx"
ANDEMITTER_MANAGER_CONTRACT="aemanagerzzz"
BOUNDED_AGG_MANAGER_CONTRACT="bamanagerzzz"
ORCHESTRATOR_MANAGER_CONTRACT="orchmanagerz"
...
ANTIBADGE_VALIDATION_CONTRACT="abvalzzzzzzz"
REPUTATION_MANAGER_VALIDATION_CONTRACT="repvalxxxxxx"
ANDEMITTER_VALIDATION_CONTRACT="emittervalzz"
BOUNDED_AGG_VALIDATION_CONTRACT="boundaggvalz"
ORCHESTRATOR_VALIDATION_CONTRACT="orchvalzzzzz"
...
ANDEMITTER_CONTRACT="andemitterzz"
BOUNDED_AGG_CONTRACT="baggzzzzzzzz"
BOUNDED_STATS_CONTRACT="bstatszzzzzz"
...
ANTIBADGE_CONTRACT="antibadgezzz"
...
AEVAL_PATH="validations/aeval"
BAVAL_PATH="validations/baval"
ORCHVAL_PATH="validations/orchval"
...
BAMANAGER_PATH="interface/bamanager"
AEMANAGER_PATH="interface/aemanager"
ORCHMANAGER_PATH="interface/orchmanager"
...
build_contract "baval" $BAVAL_PATH "$_D_PART"
...
build_contract "bamanager" $BAMANAGER_PATH "$_D_PART"
build_contract "orchmanager" $ORCHMANAGER_PATH "$_D_PART"
build_contract "orchval" $ORCHVAL_PATH "$_D_PART"
...
build_contract "aemanager" $AEMANAGER_PATH "$_D_PART"
build_contract "aeval" $AEVAL_PATH "$_D_PART"
...
# Baval
deploy_contract "$BOUNDED_AGG_VALIDATION_CONTRACT" "$BAVAL_PATH" "baval"

# Orchval
deploy_contract "$ORCHESTRATOR_VALIDATION_CONTRACT" "$ORCHVAL_PATH" "orchval"
...
# Bamanager
deploy_contract "$BOUNDED_AGG_MANAGER_CONTRACT" "$BAMANAGER_PATH" "bamanager"

# Bamanager
deploy_contract "$ORCHESTRATOR_MANAGER_CONTRACT" "$ORCHMANAGER_PATH" "orchmanager"
...
# Aeval
deploy_contract "$ANDEMITTER_VALIDATION_CONTRACT" "$AEVAL_PATH" "aeval"

# Aemanager
deploy_contract "$ANDEMITTER_MANAGER_CONTRACT" "$AEMANAGER_PATH" "aemanager"
