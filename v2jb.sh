...
build_contract "metadata" $METADATA_PATH "-DBILLING_CONTRACT=$BILLING_CONTRACT -DAUTHORITY_CONTRACT=$AUTHORITY_CONTRACT"
build_contract "orgbill" $ORGBILL_PATH "-DAUTHORITY_CONTRACT=$AUTHORITY_CONTRACT"
build_contract "simplebadge" $SIMPLEBADGE_PATH "-DORCHESTRATOR_CONTRACT_NAME=$ORCHESTRATOR_CONTRACT -DAUTHORITY_CONTRACT=$AUTHORITY_CONTRACT -DBILLING_CONTRACT=$BILLING_CONTRACT"
build_contract "gotchabadge" $GOTCHABADGE_PATH "-DORCHESTRATOR_CONTRACT_NAME=$ORCHESTRATOR_CONTRACT -DAUTHORITY_CONTRACT=$AUTHORITY_CONTRACT"
build_contract "seriesbadge" $SERIESBADGE_PATH "-DORCHESTRATOR_CONTRACT_NAME=$ORCHESTRATOR_CONTRACT -DAUTHORITY_CONTRACT=$AUTHORITY_CONTRACT"
build_contract "antibadge" $ANTIBADGE_PATH "-DCUMULATIVE_CONTRACT_NAME=$CUMULATIVE_CONTRACT -DORCHESTRATOR_CONTRACT_NAME=$ORCHESTRATOR_CONTRACT -DCHECKS_CONTRACT_NAME=$CHECKS_CONTRACT -DAUTHORITY_CONTRACT=$AUTHORITY_CONTRACT -DBOUNDED_AGG_CONTRACT_NAME=$BOUNDED_AGG_CONTRACT"
...
# Repval
build_contract "repval" $REPVAL_PATH "-DREPUTATION_INTERFACE_CONTRACT=$REPUTATION_MANAGER_CONTRACT"
...
# Mrmanager
build_contract "mrmanager" $MRMANAGER_PATH "-DGOTCHABADGE_CONTRACT=$GOTCHABADGE_CONTRACT -DORCHESTRATOR_CONTRACT=$ORCHESTRATOR_CONTRACT -DORG_CHECKS_CONTRACT=$ORG_INTERFACE_CONTRACT -DMUTUAL_RECOGNITION_VALIDATION_CONTRACT=$MUTUAL_RECOGNITION_VALIDATION_CONTRACT"

# Simmanager
build_contract "simmanager" $SIMMANAGER_PATH "-DSIMPLEBADGE_CONTRACT=$SIMPLEBADGE_CONTRACT -DORG_CHECKS_CONTRACT=$ORG_INTERFACE_CONTRACT -DSIMPLE_VALIDATION_CONTRACT=$SIMPLE_VALIDATION_CONTRACT -DORCHESTRATOR_CONTRACT=$ORCHESTRATOR_CONTRACT"

# Sermanager
build_contract "sermanager" $SERMANAGER_PATH "-DSERIESBADGE_CONTRACT=$SERIESBADGE_CONTRACT -DORCHESTRATOR_CONTRACT=$ORCHESTRATOR_CONTRACT -DORG_CHECKS_CONTRACT=$ORG_INTERFACE_CONTRACT -DSERIES_VALIDATION_CONTRACT=$SERIES_VALIDATION_CONTRACT"

# Repmanager
build_contract "repmanager" $REPMANAGER_PATH "-DSIMPLEBADGE_CONTRACT=$SIMPLEBADGE_CONTRACT -DGOTCHABADGE_CONTRACT=$GOTCHABADGE_CONTRACT -DORCHESTRATOR_CONTRACT=$ORCHESTRATOR_CONTRACT -DHLL_EMITTER_CONTRACT=$HLL_EMITTER_CONTRACT -DCUMULATIVE_CONTRACT=$CUMULATIVE_CONTRACT -DORG_CHECKS_CONTRACT_NAME=$ORG_INTERFACE_CONTRACT -DREPUTATION_MANAGER_VALIDATION_CONTRACT=$REPUTATION_MANAGER_VALIDATION_CONTRACT -DAND_EMITTER_CONTRACT=$ANDEMITTER_CONTRACT -DSTATISTICS_CONTRACT=$STATISTICS_CONTRACT -DGIVERREP_CONTRACT=$GIVER_REP_CONTRACT"

# Abmanager
build_contract "abmanager" $ABMANAGER_PATH "-DORCHESTRATOR_CONTRACT=$ORCHESTRATOR_CONTRACT -DANTIBADGE_CONTRACT=$ANTIBADGE_CONTRACT -DORG_CHECKS_CONTRACT=$ORG_INTERFACE_CONTRACT -DANTIBADGE_VALIDATION_CONTRACT=$ANTIBADGE_VALIDATION_CONTRACT"
...
# Boundedhll
build_contract "boundedhll" $BOUNDEDHLL_PATH "-DORCHESTRATOR_CONTRACT_NAME=$ORCHESTRATOR_CONTRACT -DSIMPLEBADGE_CONTRACT=$SIMPLEBADGE_CONTRACT"
...
# Redeem
build_contract "redeem" $REDEEM_PATH "-DORCHESTRATOR_CONTRACT_NAME=$ORCHESTRATOR_CONTRACT -DBOUNDED_AGG_CONTRACT_NAME=$BOUNDED_AGG_CONTRACT -DANTIBADGE_CONTRACT=$ANTIBADGE_CONTRACT"
...
# Hllemitter
build_contract "hllemitter" $HLLEMITTER_PATH "-DORCHESTRATOR_CONTRACT_NAME=$ORCHESTRATOR_CONTRACT -DSIMPLEBADGE_CONTRACT=$SIMPLEBADGE_CONTRACT -DAUTHORITY_CONTRACT=$AUTHORITY_CONTRACT"

# Giverrep
build_contract "giverrep" $GIVERREP_PATH "-DORCHESTRATOR_CONTRACT_NAME=$ORCHESTRATOR_CONTRACT -DSTATS_CONTRACT_NAME=$STATISTICS_CONTRACT -DCUMULATIVE_CONTRACT_NAME=$CUMULATIVE_CONTRACT  -DSIMPLEBADGE_CONTRACT=$SIMPLEBADGE_CONTRACT -DAUTHORITY_CONTRACT=$AUTHORITY_CONTRACT"

# Andemitter
build_contract "andemitter" $ANDEMITTER_PATH "-DORCHESTRATOR_CONTRACT_NAME=$ORCHESTRATOR_CONTRACT -DSIMPLEBADGE_CONTRACT_NAME=$SIMPLEBADGE_CONTRACT -DCLAIMASSET_CONTRACT_NAME=$CLAIMASSET_CONTRACT -DNOTIFICATION_CONTRACT_NAME=$NOTIFICATION_CONTRACT -DAUTHORITY_CONTRACT=$AUTHORITY_CONTRACT"
