...
CONTRACT bounties : public contract {
  public:
    ...
    */
   ACTION reviewers(name authorized, symbol badge_symbol, vector<name> reviewers);
    ...
    */
   ACTION participants(name authorized, symbol badge_symbol, vector<name> participants);
