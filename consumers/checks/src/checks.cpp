...
ACTION checks::onesimple(name org, name badge) {

}

ACTION checks::manysimple(name org, vector<name> badges) {

}

ACTION checks::nsimple(name org, name badge, uint64_t count) {

}

ACTION checks::haslatest(name org, name family) {
...
EOSIO_DISPATCH(checks, (hi)(clear))
